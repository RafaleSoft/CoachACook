 ...
 */
public class SettingsManager extends AppCompatPreferenceActivity
{
    ...
    public static class SettingsFragment extends PreferenceFragment
    {
        ...
        public boolean onOptionsItemSelected(MenuItem item)
        {
            if (item.getItemId() == android.R.id.home)
            {
                startActivity(new Intent(getActivity(), SettingsManager.class));
                return true;
            }
            return super.onOptionsItemSelected(item);
        }
    ...
    public static class RecipeGeneration extends SettingsFragment
    {
        ...
        {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_recipe_gen);
